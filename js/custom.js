...
Author: soldafria.net
Version:
Design and Developed by: soldafria.net
 ...
 POTENZA.stickyFooter = function () {
    var  $footerfixed = $("#footer-fixed");
       if ($footerfixed.exists()) {
         ...
         document.getElementById("main").style.marginBottom = footerheight + "";
         }
      };
...
setTimeout(function(){	document.getElementById("contactform").style.display="none";					 document.getElementById("ajaxloader").style.display="block"},10000);
};
/****************************************************
